 ...
 */
package com.lucio.mvpapp.util.retrofit.rxjava2;
...
final class RxJava2CallAdapter implements CallAdapter<Object, Object> {
    ...
    public Object adapt(@NonNull Call<Object> call) {
        Observable<Response<Object>> responseObservable = new CallObservable<>(call);
